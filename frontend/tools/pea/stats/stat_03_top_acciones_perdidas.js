/* =========================================================
   STAT 03 — TOP ACCIONES EN PÉRDIDAS (DURANTE)
   Campus CFC LITE V41
...
(function () {
  ...
  window.renderStat_03_top_acciones_perdidas = function () {
    ...
    box.insertAdjacentHTML("beforeend", window.renderCuadroBasePEA({
      ...
      universo: "Primer registro DURANTE por fecha en días con DESPUÉS = PERDIDA",
      criterios: [
        "Resultado heredado por fecha desde DESPUÉS",
