/* =========================================================
   STAT 05 — TOP PENSAMIENTOS EN GANADAS (ANTES)
   Campus CFC LITE V41
...
(function () {
  ...
  window.renderStat_05_top_pensamientos_ganadas = function () {
    ...
    box.insertAdjacentHTML("beforeend", window.renderCuadroBasePEA({
      nivel: 2,
      indice: 5,
      titulo: "Top Pensamientos en Ganadas (ANTES)",
      totalRegistros: total,
      universo: "Primer registro ANTES por fecha en días con DESPUÉS = GANADA",
      criterios: [
  ...
  function renderEmpty(box) {
    box.insertAdjacentHTML("beforeend", window.renderCuadroBasePEA({
      ...
      criterios: [
        ...
        "No hay días con DESPUÉS = GANADA que tengan ANTES válido",
      ...
      contenidoHTML: `
        <div class="pea-warning">
          ...
          <br><br>
          <strong>DESPUÉS = GANADA + ANTES válido</strong>
          <br><br>
