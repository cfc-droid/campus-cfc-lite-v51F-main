/* =========================================================
   STAT 04 — TOP EMOCIONES EN PÉRDIDAS (DESPUÉS)
   Campus CFC LITE V41
...
(function () {
  ...
  window.renderStat_04_top_emociones_perdidas_despues = function () {
...
`;
    ...
    box.insertAdjacentHTML("beforeend", window.renderCuadroBasePEA({
      nivel: 1,
      indice: 4,
      titulo: "Top Emociones en Pérdidas (DESPUÉS)",
      totalRegistros: total,
      universo: "Registros DESPUÉS con resultado = PERDIDA",
      criterios: [
  ...
  function renderEmpty(box) {
    box.insertAdjacentHTML("beforeend", window.renderCuadroBasePEA({
      ...
      criterios: [
        ...
        "No hay emociones válidas en DESPUÉS con PERDIDA"
      ],
      contenidoHTML: `
        <div class="pea-warning">
          ⚠️ Existen datos cargados, pero no hay registros
          <strong>DESPUÉS = PERDIDA</strong> con emoción válida.
          <br><br>
